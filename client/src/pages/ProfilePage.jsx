  ...
  useEffect(() => {
    async function getOrderList() {
      const res = await getDetails(
        "http://ec2-16-171-29-86.eu-north-1.compute.amazonaws.com:8081/orders/?limit=3"
      );
...
const UserAddress = () => {
  ...
  const handleSubmit = asyncHandler(async (e) => {
    e.preventDefault();
    const res = await postDetails("http://ec2-16-171-29-86.eu-north-1.compute.amazonaws.com:8081/address/", formData);
    if (res.status === 304) {
  ...
  const handleDelete = (id) => {
    ...
    deleteItem(`http://ec2-16-171-29-86.eu-north-1.compute.amazonaws.com:8081/address/${id}`);
  };
  ...
  useEffect(() => {
    async function getAddressList() {
      const res = await getDetails("http://ec2-16-171-29-86.eu-north-1.compute.amazonaws.com:8081/address/");
      if (res.list == null) {
        setAddresses([]);
      } else {
...
const ProfilePage = () => {
  ...
  useEffect(() => {
    async function getAboutUser() {
      const res = await getDetails(
        "http://ec2-16-171-29-86.eu-north-1.compute.amazonaws.com:8081/users/"
      );
