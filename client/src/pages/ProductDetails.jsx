...
function ProductDetails() {
  ...
  useEffect(() => {
    asyncHandler(async () => {
      const res = await getDetails(
        `http://ec2-16-171-29-86.eu-north-1.compute.amazonaws.com:8081/product?productId=${productId}`
      )
  ...
  useEffect(() => {
    ...
    asyncHandler(async () => {
      const res = await getDetails(
        `http://ec2-16-171-29-86.eu-north-1.compute.amazonaws.com:8081/cart/productIsPresent?user=${currentUser?._id}&product_item=${productDetails._id}`
      )
  ...
  const handleAddToCart = async () => {
    ...
    try {
      setIsLoading(true)
      await postDetails('http://ec2-16-171-29-86.eu-north-1.compute.amazonaws.com:8081/cart/add', {
