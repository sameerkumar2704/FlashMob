...
function ColorSelector({ selectedColor, setSelectedColor, color }) {
  return (
    <div
      ...
      className={`w-6 h-6 sm:w-8 sm:h-8 border-2 rounded-full cursor-pointer ${color ===
      selectedColor
        ? "border-red-950 "
        : "border-gray-300"}`}
    />
...
function SizeSelector({ selectedSize, setSelectedSize, currSize }) {
  return (
    <div
      className={`text-xs sm:text-sm border w-8 h-8 sm:w-10 sm:h-10 flex items-center justify-center cursor-pointer rounded-md ${currSize ===
      selectedSize
      ...
      <div>
        ...
        <div className="flex flex-wrap gap-4 items-center mb-6">
          <div className="flex items-center border border-gray-300 rounded-md">
            ...
            <span className="px-4 sm:px-6 py-1 sm:py-2">
              {quantity}
            </span>
            <button
          ...
          <button className="bg-red-500 text-white px-4 py-2 sm:px-6 sm:py-3 rounded-md shadow-md">
            Add to Cart
          </button>
