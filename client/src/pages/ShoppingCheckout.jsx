...
const ShoppingCheckout = () => {
  ...
  useEffect(() => {
    async function getSingleProduct() {
      ...
      const res = await getDetails(
        `https://ec2-16-171-29-86.eu-north-1.compute.amazonaws.com:8081/product?productId=${searchQuery.get(
          "productId"
        )}`
      );
  ...
  useEffect(() => {
    async function getAddressList() {
      const res = await getDetails(
        "https://ec2-16-171-29-86.eu-north-1.compute.amazonaws.com:8081/address/"
      );
