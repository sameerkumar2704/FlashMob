...
const ShoppingCheckout = () => {
  ...
  useEffect(() => {
    async function getSingleProduct() {
      ...
      const res = await getDetails(
        `http://ec2-16-171-29-86.eu-north-1.compute.amazonaws.com:8081/product?productId=${searchQuery.get(
          "productId"
        )}`
      );
    ...
    async function getCartProducts() {
      setIsLoading(true);
      const res = await getDetails(
        "http://ec2-16-171-29-86.eu-north-1.compute.amazonaws.com:8081/cart/all"
      );
  ...
  useEffect(() => {
    async function getAddressList() {
      const res = await getDetails(
        "http://ec2-16-171-29-86.eu-north-1.compute.amazonaws.com:8081/address/"
      );
