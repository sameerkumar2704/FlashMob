        ...
        onClick={asyncHandler(async () => {
          ...
          try {
            ...
            const result = await postDetails(
              "http://ec2-16-171-29-86.eu-north-1.compute.amazonaws.com:8081/users/register",
              obj
            );
            ...
            const userDetail = await postDetails(
              "http://ec2-16-171-29-86.eu-north-1.compute.amazonaws.com:8081/users/login",
              obj
            );
    ...
    <form
      ...
      onSubmit={asyncHandler(async e => {
        ...
        const resp = await postDetails(
          "http://ec2-16-171-29-86.eu-north-1.compute.amazonaws.com:8081/address/add",
          {
      ...
      <Button
        onClick={asyncHandler(async () => {
          try {
            ...
            const result = await postDetails(
              "http://ec2-16-171-29-86.eu-north-1.compute.amazonaws.com:8081/users/forgotPassword",
              obj
            );
            if (result.status === "failed") throw new Error(result.message);
        ...
        onClick={asyncHandler(async () => {
          try {
            ...
            const result = await patchDetails(
              `http://ec2-16-171-29-86.eu-north-1.compute.amazonaws.com:8081/users/resetPassword/${resetToken
                .current.value}`,
              {
                password: password.current.value
              }
